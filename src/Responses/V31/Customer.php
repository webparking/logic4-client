...
namespace Webparking\Logic4Client\Responses\V31;
...
class Customer
{
    ...
    public function __construct(
        ...
        public bool $hide,
        public ?\Webparking\Logic4Client\Data\V31\VatCode $vatCode,
        public ?\Webparking\Logic4Client\Data\V31\Representative $representative,
        public ?\Webparking\Logic4Client\Data\V31\RelationType $type,
        public ?\Webparking\Logic4Client\Data\V31\Gender $gender,
        public ?\Webparking\Logic4Client\Data\V31\RelationStatus $status,
        public ?string $invoiceEmail,
        public ?string $paymentReminderEmail,
        public ?string $firstClickGclIdValues,
        public ?string $firstClickUtmValues,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            vatCode: isset($data['VatCode']) ? \Webparking\Logic4Client\Data\V31\VatCode::make($data['VatCode']) : null,
            representative: isset($data['Representative']) ? \Webparking\Logic4Client\Data\V31\Representative::make($data['Representative']) : null,
            type: isset($data['Type']) ? \Webparking\Logic4Client\Data\V31\RelationType::make($data['Type']) : null,
            gender: isset($data['Gender']) ? \Webparking\Logic4Client\Data\V31\Gender::make($data['Gender']) : null,
            status: isset($data['Status']) ? \Webparking\Logic4Client\Data\V31\RelationStatus::make($data['Status']) : null,
            invoiceEmail: $data['InvoiceEmail'] ?? null,
            paymentReminderEmail: $data['PaymentReminderEmail'] ?? null,
            firstClickGclIdValues: $data['FirstClickGclIdValues'] ?? null,
            firstClickUtmValues: $data['FirstClickUtmValues'] ?? null,
