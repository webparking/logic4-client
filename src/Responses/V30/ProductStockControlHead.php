...
{
    /** @param array<\Webparking\Logic4Client\Data\V30\ProductStockControlRow> $rows */
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            rows: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\ProductStockControlRow::make($item), $data['Rows'] ?? []),
