...
{
    /** @param array<\Webparking\Logic4Client\Data\V30\FinancialBookBookingMutation> $mutations */
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            mutations: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\FinancialBookBookingMutation::make($item), $data['Mutations'] ?? []),
        );
    }
}
