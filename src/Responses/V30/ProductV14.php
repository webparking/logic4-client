...
{
    /**
     * @param array<\Webparking\Logic4Client\Data\V30\ProductShiftPriceV14>  $shiftPrices
     * @param array<\Webparking\Logic4Client\Data\V30\FreeValue>             $freeValues
     * @param array<\Webparking\Logic4Client\Data\V30\Translation>           $descriptions
     * @param array<\Webparking\Logic4Client\Data\V30\ProductGroup>          $productGroups
     * @param array<\Webparking\Logic4Client\Data\V30\ProductExtraBarcode>   $barcodeExtraList
     * @param array<\Webparking\Logic4Client\Data\V30\ProductStockWarehouse> $wareHouses
    ...
    public function __construct(
        ...
        public float $weight,
        public float $volume,
        public ?\Webparking\Logic4Client\Data\V30\ProductOffer $offer,
        ...
        public ?\Webparking\Logic4Client\Data\V30\ProductType $productType1,
        public ?\Webparking\Logic4Client\Data\V30\ProductType $productType2,
        public ?\Webparking\Logic4Client\Data\V30\ProductType $productType3,
        public ?\Webparking\Logic4Client\Data\V30\ProductType $productType4,
        public ?\Webparking\Logic4Client\Data\V30\ProductType $productType5,
        public ?float $standardAmount,
        public ?int $standardAmountUnitId,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            shiftPrices: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\ProductShiftPriceV14::make($item), $data['ShiftPrices'] ?? []),
            ...
            offer: isset($data['Offer']) ? \Webparking\Logic4Client\Data\V30\ProductOffer::make($data['Offer']) : null,
            ...
            freeValues: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\FreeValue::make($item), $data['FreeValues'] ?? []),
            sorting: $data['Sorting'] ?? null,
            nextDelivery: isset($data['NextDelivery']) ? \Carbon\Carbon::parse($data['NextDelivery']) : null,
            descriptions: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\Translation::make($item), $data['Descriptions'] ?? []),
            productGroups: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\ProductGroup::make($item), $data['ProductGroups'] ?? []),
            ...
            wareHouses: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\ProductStockWarehouse::make($item), $data['WareHouses'] ?? []),
            ...
            productType1: isset($data['ProductType1']) ? \Webparking\Logic4Client\Data\V30\ProductType::make($data['ProductType1']) : null,
            productType2: isset($data['ProductType2']) ? \Webparking\Logic4Client\Data\V30\ProductType::make($data['ProductType2']) : null,
            productType3: isset($data['ProductType3']) ? \Webparking\Logic4Client\Data\V30\ProductType::make($data['ProductType3']) : null,
            productType4: isset($data['ProductType4']) ? \Webparking\Logic4Client\Data\V30\ProductType::make($data['ProductType4']) : null,
            productType5: isset($data['ProductType5']) ? \Webparking\Logic4Client\Data\V30\ProductType::make($data['ProductType5']) : null,
            standardAmount: $data['StandardAmount'] ?? null,
            standardAmountUnitId: $data['StandardAmountUnitId'] ?? null,
