...
class CRMProject
{
    public function __construct(
        ...
        public ?\Webparking\Logic4Client\Data\V30\CRMProjectStatus $status,
        public ?\Webparking\Logic4Client\Data\V30\CRMProjectType $type,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            status: isset($data['Status']) ? \Webparking\Logic4Client\Data\V30\CRMProjectStatus::make($data['Status']) : null,
            type: isset($data['Type']) ? \Webparking\Logic4Client\Data\V30\CRMProjectType::make($data['Type']) : null,
