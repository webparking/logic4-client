...
class WebshopUserProductOfProductV12
{
    public function __construct(
        ...
        public ?\Webparking\Logic4Client\Data\V30\ProductV12 $productInformation,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            productInformation: isset($data['ProductInformation']) ? \Webparking\Logic4Client\Data\V30\ProductV12::make($data['ProductInformation']) : null,
