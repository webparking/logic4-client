...
class CustomerContact
{
    public function __construct(
        ...
        public ?\Webparking\Logic4Client\Data\V30\Gender $gender,
        public ?string $initials,
        public ?string $insertionName,
        public ?string $lastName,
        public ?string $mobileNumber,
        public ?\Carbon\Carbon $createdDateTime,
        public ?\Carbon\Carbon $changedDateTime,
        public ?int $id,
        public ?int $debtorId,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            gender: isset($data['Gender']) ? \Webparking\Logic4Client\Data\V30\Gender::make($data['Gender']) : null,
            initials: $data['Initials'] ?? null,
            insertionName: $data['InsertionName'] ?? null,
            lastName: $data['LastName'] ?? null,
            mobileNumber: $data['MobileNumber'] ?? null,
            createdDateTime: isset($data['CreatedDateTime']) ? \Carbon\Carbon::parse($data['CreatedDateTime']) : null,
            changedDateTime: isset($data['ChangedDateTime']) ? \Carbon\Carbon::parse($data['ChangedDateTime']) : null,
            id: $data['Id'] ?? null,
