...
class EmailUser
{
    /** @param array<\Webparking\Logic4Client\Data\V30\EmailUserEmailAddress> $emailAddresses */
    ...
    {
        return new self(
            emailAddresses: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\EmailUserEmailAddress::make($item), $data['EmailAddresses'] ?? []),
