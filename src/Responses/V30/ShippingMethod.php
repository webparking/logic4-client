...
class ShippingMethod
{
     ...
     * @param array<\Webparking\Logic4Client\Data\V30\WebsiteDomain> $websiteDomains
     */
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            websiteDomains: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\WebsiteDomain::make($item), $data['WebsiteDomains'] ?? []),
        );
    }
}
