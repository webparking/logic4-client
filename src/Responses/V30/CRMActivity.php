...
class CRMActivity
{
    public function __construct(
        ...
        public ?string $notes,
        public ?\Webparking\Logic4Client\Data\V30\CRMActivityStatus $status,
        public ?\Webparking\Logic4Client\Data\V30\CRMActivityType $type,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            status: isset($data['Status']) ? \Webparking\Logic4Client\Data\V30\CRMActivityStatus::make($data['Status']) : null,
            type: isset($data['Type']) ? \Webparking\Logic4Client\Data\V30\CRMActivityType::make($data['Type']) : null,
