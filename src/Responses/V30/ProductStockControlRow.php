...
{
    /** @param array<\Webparking\Logic4Client\Data\V30\ProductExtraBarcode> $barcodeExtraList */
    public function __construct(
        ...
        public ?\Carbon\Carbon $stockLevelDate,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            stockLevelDate: isset($data['StockLevelDate']) ? \Carbon\Carbon::parse($data['StockLevelDate']) : null,
            barcode: $data['Barcode'] ?? null,
            productCode: $data['ProductCode'] ?? null,
            barcode2: $data['Barcode2'] ?? null,
            systemBarcode: $data['SystemBarcode'] ?? null,
            barcodeExtraList: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\ProductExtraBarcode::make($item), $data['BarcodeExtraList'] ?? []),
        );
    }
}
