...
class ProductGroup
{
    /** @param array<\Webparking\Logic4Client\Data\V30\ProductGroupTranslation> $translations */
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            translations: array_map(static fn (array $item) => \Webparking\Logic4Client\Data\V30\ProductGroupTranslation::make($item), $data['Translations'] ?? []),
        );
    }
}
