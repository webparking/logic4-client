...
class CustomerAddress
{
    public function __construct(
        public ?\Webparking\Logic4Client\Data\V30\AddressType $type,
        public ?\Webparking\Logic4Client\Data\V30\Province $province,
        public ?string $email,
    ...
    {
        return new self(
            type: isset($data['Type']) ? \Webparking\Logic4Client\Data\V30\AddressType::make($data['Type']) : null,
            province: isset($data['Province']) ? \Webparking\Logic4Client\Data\V30\Province::make($data['Province']) : null,
