...
class ITSIssue
{
    ...
    public static function make(array $data): self
    {
        return new self(
            id: $data['id'] ?? 0,
            name: $data['Name'] ?? null,
            dateTimeCreatedOn: isset($data['DateTimeCreatedOn']) ? Carbon::parse($data['DateTimeCreatedOn']) : null,
            dateTimeClosed: isset($data['DateTimeClosed']) ? Carbon::parse($data['DateTimeClosed']) : null,
            ...
            dateTimeMustBeCompletedOn: isset($data['DateTimeMustBeCompletedOn']) ? Carbon::parse($data['DateTimeMustBeCompletedOn']) : null,
            ...
            lastModifiedSince: isset($data['LastModifiedSince']) ? Carbon::parse($data['LastModifiedSince']) : null,
            reportedByDebtorId: $data['ReportedByDebtorId'] ?? null,
            reportedByCreditorId: $data['ReportedByCreditorId'] ?? null,
            contactId: $data['ContactId'] ?? null,
            dateTimeReported: isset($data['DateTimeReported']) ? Carbon::parse($data['DateTimeReported']) : null,
