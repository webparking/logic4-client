...
class EmailMessage
{
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            boxId: $data['BoxId'] ?? 0,
            dateTimeSend: isset($data['DateTimeSend']) ? Carbon::parse($data['DateTimeSend']) : null,
            isInbound: $data['IsInbound'] ?? false,
            isRead: $data['IsRead'] ?? false,
            isReplyedOn: isset($data['IsReplyedOn']) ? Carbon::parse($data['IsReplyedOn']) : null,
            isForwardedOn: isset($data['IsForwardedOn']) ? Carbon::parse($data['IsForwardedOn']) : null,
