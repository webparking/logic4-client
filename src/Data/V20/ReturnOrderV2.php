...
{
    /**
     * @param array<\Webparking\Logic4Client\Data\V20\OrderShipment> $orderShipments
     * @param array<\Webparking\Logic4Client\Data\V20\Payment>       $payments
     * @param array<\Webparking\Logic4Client\Data\V20\OrderRow>      $orderRows
     */
    public function __construct(
        public int $categoryId,
        public ?ReturnProblem $problem,
        public ?ReturnSolution $solution,
        public int $originalOrderId,
        public ?\Carbon\Carbon $approvedReturnOrderDate,
        public ?\Carbon\Carbon $receivedReturnOrderDate,
        public int $debtorId,
        public int $id,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            problem: isset($data['Problem']) ? ReturnProblem::make($data['Problem']) : null,
            solution: isset($data['Solution']) ? ReturnSolution::make($data['Solution']) : null,
            originalOrderId: $data['OriginalOrderId'] ?? 0,
            approvedReturnOrderDate: isset($data['ApprovedReturnOrderDate']) ? \Carbon\Carbon::parse($data['ApprovedReturnOrderDate']) : null,
            receivedReturnOrderDate: isset($data['ReceivedReturnOrderDate']) ? \Carbon\Carbon::parse($data['ReceivedReturnOrderDate']) : null,
