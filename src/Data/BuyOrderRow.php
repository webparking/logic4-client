...
class BuyOrderRow
{
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            expectedDeliveryDate: isset($data['ExpectedDeliveryDate']) ? Carbon::parse($data['ExpectedDeliveryDate']) : null,
            qtyToOrder: $data['QtyToOrder'] ?? 0.0,
            orderedOnDateByDistributor: isset($data['OrderedOnDateByDistributor']) ? Carbon::parse($data['OrderedOnDateByDistributor']) : null,
