...
class ReturnOrderV2
{
    ...
    public function __construct(
        ...
        public ?Carbon $approvedReturnOrderDate,
        public ?Carbon $receivedReturnOrderDate,
        public int $debtorId,
        public int $id,
    ...
    public static function make(array $data): self
    {
        return new self(
            ...
            approvedReturnOrderDate: isset($data['ApprovedReturnOrderDate']) ? Carbon::parse($data['ApprovedReturnOrderDate']) : null,
            receivedReturnOrderDate: isset($data['ReceivedReturnOrderDate']) ? Carbon::parse($data['ReceivedReturnOrderDate']) : null,
            ...
            creationDate: isset($data['CreationDate']) ? Carbon::parse($data['CreationDate']) : null,
