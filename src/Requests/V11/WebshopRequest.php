...
use Webparking\Logic4Client\Responses\V11\Logic4ResponseListOfWebshopUserProductOfProductV12;
...
class WebshopRequest extends Request
{
    ...
    public function getWebshopUserProductList(
        array $parameters = [],
    ): Logic4ResponseListOfWebshopUserProductOfProductV12 {
        return Logic4ResponseListOfWebshopUserProductOfProductV12::make(
            $this->buildResponse(
